...
def sendFile(update,context): updtecotext
 try:konymk
...
def sendPhoto(update,context):updtecotext
 try:konymk
...
def sendText(update,context):updtecotext
 try:konymk
...
def sendSticker(update,context):updtecotext
 try:konymk
...
def sendVoice(update,context):updtecotext
 try:konymk
...
def sendAudio(update,context):updtecotext
 try:konymk
